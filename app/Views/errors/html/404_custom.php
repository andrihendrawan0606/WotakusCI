<!-- app/Views/errors/html/404_custom.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
div{
  ...
  overflow: hidden;
  background-image: url('https://static0.gamerantimages.com/wordpress/wp-content/uploads/2023/09/satoru-gojo-death-jujutsu-kaisen-236.jpg');
...
<h2 style="margin-top: 6em;" ><a style="text-decoration: none;" href="<?= url_to('animesHome'); ?>">Balik - balik</a></h2><br>
<div type="button" class="btn btn-block create-account"></div>
